...
import (
	...
	"guarantees/data/additional/guarantor"
	"guarantees/data/additional/organization"
	"guarantees/data/additional/rejtype"
	"guarantees/data/additional/rtype"
	"guarantees/data/primary/document"
	"guarantees/data/primary/guarantee"
	"guarantees/data/primary/part"
	"guarantees/data/primary/reject"
	"guarantees/data/primary/requirement"
	"guarantees/data/primary/rrequirement"
